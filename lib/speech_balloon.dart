...
enum NipLocation { top, right, bottom, left, bottomRight, bottomLeft, topRight, topLeft }
...
class SpeechBalloon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        //if (borderColor != null) Stack(alignment: alignment, children: [nip(nipOffset), balloon()]),
        Stack(alignment: alignment, children: [frontNip(innerNipOffset), frontBalloon()]),
      ],
    );
  }
    ...
    return Transform.translate(
      ...
      child: RotationTransition(
        ...
        child: Material(
          ...
          color: color,
          child: Container(height: nipHeight, width: nipHeight),
        ),
      ),
    );
  }
